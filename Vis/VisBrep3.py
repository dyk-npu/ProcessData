...
if __name__ == "__main__":
    ...
    # ### 修改点 1: 在创建实例后设置背景颜色 ###
    # 通过访问底层的 viewer 对象来设置背景色
    # 我们需要创建一个 Quantity_Color 对象
    white_color = Quantity_Color(1.0, 1.0, 1.0, Quantity_TOC_RGB)
    v.viewer.SetBackgroundColor(white_color)

    # 定义你想要的淡蓝色或其他颜色
    light_blue_color = (0.678, 0.847, 0.902)  # 这是一个淡蓝色的RGB值
    darker_blue_for_edges = (0.3, 0.5, 0.8)   # 一个更深一点的蓝色用于边框
    ...
    display_all_edges(
        ...
        default_color=darker_blue_for_edges,
        fake_width=18
    )
