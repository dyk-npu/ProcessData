...
def draw_face_uvgrids(solid, graph, viewer,num_face):

    for face_idx in num_face:

        a_face_data = graph.ndata["x"][face_idx]
...
if __name__ == "__main__":
    ...
    args.solid = 'D:\CAD数据集\j1.0.0\joint\step\\137295_a2385b57_0000_1.step'
    ...
    draw_face_uvgrids(solid, graph, viewer = v,num_face = [13])
