...
# 文件夹路径
bin_dir = '../../Data/MFInstSeg/attr/testbin'
labels_dir = '../../Data/MFInstSeg/labels/'
...
for file_name in tqdm(file_names, desc="Processing MFInstSeg"):
    if file_name.endswith('.bin_global'):
        ...
        label = list(labels[0][1]['seg'].values())
...
# with open("../Data/MFInstSeg/labels/20221121_154647_1.json", 'r') as f:
#     labels = json.load(f)
#
# label = labels[0][1]['seg']
#
# l = list(label.values())
#
# print(l)
