...
def extract_surface_data(face, max_ctrl_setting=10, max_uvlength_setting=10):
    try:
        # 直接获取NURBS表面数据
        ...
        return pw, u_kv, v_kv, points
        
    except Exception as e:
        print(f"Error in extract_surface_data: {e}")
        return None
...
def array_from_Array1OfReal(array):
    ...
    return np.asarray(values)
def get_nurbs_data(face, max_ctrl_setting=20, max_uvlength_setting=20):
    try:
